...
const Register = () => {
  const { register, error, setError, token } = useContext(AuthContext);
    ...
    <div className="page-container d-flex align-items-center justify-content-center" style={{ minHeight: '70vh' }}>
      <div className="card border-0 shadow-lg p-4 bg-white rounded-premium w-100" style={{ maxWidth: '420px' }}>
        <div className="text-center mb-4">
          ...
          <p className="text-muted small">Register to browse catalog, build carts & place orders</p>
        </div>

        {displayedError && <div className="alert alert-danger alert-custom small py-2 mb-3">{displayedError}</div>}
